...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [
		...
		['Senpai', 'Roses', 'Thorns'],
		['Syntax','Overload','BSOD'],
		['New modes, songs,','Story, features,','characters','and way more']
	];
	...
	private var syntechBG:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 400, 0xFF8e32f9);
	...
	override function create()
	{
		...
		sprDifficulty.animation.addByPrefix('rage', 'RAGE');
		...
		if (weekUnlocked[curWeek])
		{
			if (stopspamming == false)
			{
				...
				if (curWeek == 7)
					{
						trace("POINTTTTT!!!!!!!!!!!!!!");
						grpWeekCharacters.members[0].animation.play('HEPOINT');
					}
				stopspamming = true;
			}
			...
			new FlxTimer().start(1, function(tmr:FlxTimer)
			{
				if (curWeek == 8)
					{
						trace("cutscene!"); //WE WERE JUST TESTING SHIT ALRIGHT?
						//FlxG.switchState(new VideoState('assets/videos/Intro.webm', new StoryMenuState()));
						fancyOpenURL("https://gamebanana.com/mods/309557");
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		{
			case 8:
				sprDifficulty.animation.play('rage');
				sprDifficulty.offset.x = 20;
		}*/
