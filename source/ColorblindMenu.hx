...
class ColorblindMenu extends FlxSubState
{

    var keyTextDisplay:FlxText;
    var keyWarning:FlxText;
    var warningTween:FlxTween;
    var keyText:Array<String> = ["Deuteranopia", "Protanopia", "Tritanopia", "Invert"];
    var defaultKeys:Array<Bool> = [false,false,false,false];
    var curSelected:Int = 0;

    var keys:Array<Bool> = [FlxG.save.data.filter1,
                              FlxG.save.data.filter2,
                              FlxG.save.data.filter3,
                              FlxG.save.data.filter4];
    var tempKey:String = "";
	...
	{	
        ...
        infoText = new FlxText(-10, 580, 1280, 'Current Mode: ${KeyBinds.gamepad ? 'GAMEPAD' : 'KEYBOARD'}. Press TAB to switch\n(${KeyBinds.gamepad ? 'RIGHT Trigger' : 'Escape'} to save, ${KeyBinds.gamepad ? 'LEFT Trigger' : 'Backspace'} to leave without saving. ${KeyBinds.gamepad ? 'START To toggle' : ''})', 72);
    ...
    function save(){
        ...
        FlxG.save.data.filter1 = keys[2];
        FlxG.save.data.filter2 = keys[1];
        FlxG.save.data.filter3 = keys[0];
        FlxG.save.data.filter4 = keys[3];
