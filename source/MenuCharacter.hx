...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'syntech' => new CharacterSetting(-15, 130, true)
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		frames = Paths.getSparrowAtlas('dude');
		...
		animation.addByPrefix('syntech', "SYN anim IDLE", 24);
		animation.addByPrefix('HEPOINT', "SYN anim LEFT", 24);
